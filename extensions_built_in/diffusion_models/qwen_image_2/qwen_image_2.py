...
class QwenImage2Model(BaseModel):
    ...
    def load_model(self):
        ...
        # conditioning reads hidden states, never logits: a quantized lm_head
        # re-materializes a full-vocab 1.2 GB bf16 weight on every forward,
        # which OOMs 16 GB cards during text embedding caching
